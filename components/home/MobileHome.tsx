  ...
  return (
    <div className='flex lg:hidden flex-col'>
      <main className='flex flex-col'>
          ...
          <div className='flex flex-col mx-auto px-4 mt-12'>
            <div className='flex flex-col px-4 gap-4'>
              <div className='flex flex-col gap-8'>
                <span className={`font-normal text-4xl text-gradient-copy-top-traders text-center ${anton.className}`}>
                  COPY TOP TRADERS AND EARN SMARTER
                </span>
                <p className='font-normal text-sm text-[#FFFFFFB2] text-center'>
                  Streple lets you mirror top traders in real-time, no experience needed.
                </p>
              </div>

              <div className='flex flex-col gap-4 items-center'>
                <Link href="#" className="flex flex-row w-max items-center rounded-3xl px-4 py-2.5 gap-3 bg-[#B39FF0] font-bold text-sm text-[#2C2D28]">
                  Start coying trades
                  <GoArrowRight size={20} />
                </Link>

                <Link href="#" className="flex flex-row w-max items-center gap-3 font-bold text-lg text-[#EBF0D5]">
        ...
        <section className='flex flex-col section-1-bg-mobile mx-auto px-4'>
          <div className='flex flex-col mt-18 gap-4'>
            <div className={`items-center text-center text-[27px] text-white font-normal ${anton.className}`}>
              <span className="text-[#B39FF0]">With Streple</span>
              <span className="text-gradient-with-streple">, Trading becomes easier</span>
            </div>

            <p className="font-normal text-sm text-[#FFFFFFB2] max-w-[353px] text-center mx-auto">
          ...
          <div className='flex flex-col gap-10 mt-20'>
            <div className="flex flex-row gap-6 items-center">
              <div className="flex flex-row justify-center items-center w-[75px] h-[75px] border border-[#70568D47] rounded-[46px] bg-[#5A555C1A]">
                <span className="font-normal text-[27px] text-[#DDC4F8]">1</span>
              </div>
              <p className={`font-normal text-2xl text-white ${roboto.className}`}>
                Sign Up
              </p>
            </div>
            ...
            <div className="flex flex-row gap-6 items-center">
              <div className="flex flex-row justify-center items-center w-[75px] h-[75px] border border-[#70568D47] rounded-[46px] bg-[#5A555C1A]">
                <span className="font-normal text-[27px] text-[#DDC4F8]">2</span>
              </div>
              <p className={`font-normal text-2xl text-white ${roboto.className}`}>
            ...
            <div className="flex flex-row gap-6 items-center">
              <div className="flex flex-row justify-center items-center w-[75px] h-[75px] border border-[#70568D47] rounded-[46px] bg-[#5A555C1A]">
                <span className="font-normal text-[27px] text-[#DDC4F8]">3</span>
              </div>
              <p className={`font-normal text-2xl text-white ${roboto.className}`}>Start copying Trades</p>
            </div>
          </div>
        </section>

        {/* Section 2 - Earn profits without lifting a finger */}
        <section className='flex flex-col section-2-bg-mobile mx-auto px-4'>
          <div className="flex flex-col mt-18 gap-6">
            ...
            <span className={`text-gradient-earn-profits font-normal text-[27px] ${anton.className}`}>
            ...
            <div className="flex flex-col gap-6">
              ...
              <Link href="#" className="flex flex-row items-center gap-3 font-bold text-base text-[#DFD735]">
                Get started
        ...
        <section className='flex flex-col section-3-bg-mobile mx-auto px-4'>
          <div className="flex flex-col mt-18 gap-6">
            <div className="why-people-choose-us w-max">
              <span className="font-normal text-xs text-white">Why people choose us</span>
            </div>
        ...
        <section className='flex flex-col section-4-bg-mobile mx-auto px-4'>
          <div className="flex flex-col gap-13 items-center mx-auto">
            <div className='flex flex-col mt-18 gap gap-6 items-center mx-auto'>
              ...
              <span className={`font-normal text-[27px] text-gradient-real-results ${anton.className}`}>
        ...
        <section className='flex flex-col section-5-bg-mobile mx-auto px-4'>
          <div className="flex flex-col mt-18 gap-6">
            <span className={`font-normal text-[27px] text-gradient-real-results ${anton.className}`}>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-row items-center gap-4">
                <FaRegCheckCircle size={16} className="font-extrabold text-[#FFFFFFA6]" />
                <span className="font-normal text-sm text-white">Verified traders</span>
              </div>

              <div className="flex flex-row items-center gap-4">
                <FaRegCheckCircle size={16} className="font-extrabold text-[#FFFFFFA6]" />
                <span className="font-normal text-sm text-white">Risk control tools</span>
              </div>
            </div>
          </div>
        ...
        <section className='flex flex-col section-6-bg-mobile'>
          <div className="flex flex-col mx-auto mt-18 gap-10 w-[359px] h-[439px] bg-[#FFFFFF0D] rounded-[26px] justify-center px-2">
            <span className={`flex flex-row mx-auto justify-center text-center font-normal text-[27px] text-white ${anton.className}`}>
            ...
            <div className="flex flex-col items-center gap-6 mx-auto">
              <Link href="#" className="flex flex-row items-center rounded-[20px] px-[16px] py-[12px] gap-2.5 bg-[#F4E90E] hover:bg-[#CEC510]">
                <span className="font-bold text-sm text-[#2C2C26]">Start copying trades</span>
                <GoArrowRight size={16} className="text-[#2C2D28]" />
              </Link>
              <Link href="#" className="flex flex-row items-center gap-3">
                <span className="font-bold text-base text-[#EBF0D5]">Streple for Pro traders</span>
