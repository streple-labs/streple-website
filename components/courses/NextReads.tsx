...
export default function NextReads({ currentCourseId }: NextReadsProps) {
    ...
    const recommendedCourses = allCourses ? getNextThreeCourses(allCourses.data, currentCourseId) : [];
    ...
    if (recommendedCourses.length === 0) {
        return null; // Don't render the section if there's nothing to recommend
    }
