...
export const metadata: Metadata = {
  ...
  description: "Mirror top traders in real time with Streple. Start trading like a pro in 3 simple steps — no experience needed. Copy verified experts, automate your trades, and earn smarter.",
  keywords: [
    'copy trading',
    'automated trading',
    'top traders',
